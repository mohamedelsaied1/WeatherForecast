...
def getWeather():
    ...
    webbrowser.open("https://earth.google.com/web/search/"+str(location.latitude)+"+"+str(location.longitude))
...
Labe2 = Label(root,text="Humidity",font=('Helvetica',11),fg="white",bg="#203243")
Labe2.place(x=50,y=140)

Labe3 = Label(root,text="Pressure",font=('Helvetica',11),fg="white",bg="#203243")
Labe3.place(x=50,y=160)

Labe4 = Label(root,text="Wind Speed",font=('Helvetica',11),fg="white",bg="#203243")
Labe4.place(x=50,y=180)

Labe5 = Label(root,text="Description",font=('Helvetica',11),fg="white",bg="#203243")
Labe5.place(x=50,y=200)
...
long_lat = Label(root,font=("Helvetica",22,'bold'),fg="white",bg="#57adff")
